...
export default function HomePage() {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Kategorie turnaje */}
      <div className="flex space-x-2 md:space-x-4 overflow-x-auto pl-4 md:pl-0 justify-start">
          ...
          <button
            ...
            className={`px-4 py-2 rounded-full text-lg font-medium transition whitespace-nowrap shadow-sm border my-1 ${
              selectedCategory === category
                ...
                : "bg-white text-gray-700 border-gray-300 hover:bg-gradient-to-b hover:from-primary/30 hover:to-transparent"
            }`}
